...
trie_vec_lookup_x16x2(void *p, uint8_t ips[32][IPV6_ADDR_LEN], uint64_t *next_hops, int size)
{
    ...
    shuf_idxes = _mm512_setr_epi32(3, 7, 11, 15, 19, 23, 27, 31, 35, 39, 43, 47, 51, 55, 59, 63);

    base_idxes = _mm512_setr_epi32(0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60);
    ...
    while (msk_ext_1 || msk_ext_2) {
        ...
        byte_chunk_1 = (i < 8) ? ((i >= 4) ? second_1 : first_1) : ((i >= 12) ? fourth_1 : third_1);
        byte_chunk_2 = (i < 8) ? ((i >= 4) ? second_2 : first_2) : ((i >= 12) ? fourth_2 : third_2);
        ...
        if (size == sizeof(uint16_t)) {
            tmp_1 = _mm512_mask_i32gather_epi32(zero, msk_ext_1, idxes_1, (const int *)dp->tbl8, 2);
            tmp_2 = _mm512_mask_i32gather_epi32(zero, msk_ext_2, idxes_2, (const int *)dp->tbl8, 2);
            tmp_1 = _mm512_and_epi32(tmp_1, res_msk);
            tmp_2 = _mm512_and_epi32(tmp_2, res_msk);
        } else {
            tmp_1 = _mm512_mask_i32gather_epi32(zero, msk_ext_1, idxes_1, (const int *)dp->tbl8, 4);
            tmp_2 = _mm512_mask_i32gather_epi32(zero, msk_ext_2, idxes_2, (const int *)dp->tbl8, 4);
        }
...
trie_vec_lookup_x8x2_8b(void *p, uint8_t ips[16][IPV6_ADDR_LEN], uint64_t *next_hops)
{
    ...
    const __cne_x86_zmm_t bswap = {
        .u8 = {2, 1, 0, 255, 255, 255, 255, 255, 10, 9, 8, 255, 255, 255, 255, 255,
               2, 1, 0, 255, 255, 255, 255, 255, 10, 9, 8, 255, 255, 255, 255, 255,
               2, 1, 0, 255, 255, 255, 255, 255, 10, 9, 8, 255, 255, 255, 255, 255,
               2, 1, 0, 255, 255, 255, 255, 255, 10, 9, 8, 255, 255, 255, 255, 255},
    };
    ...
    while (msk_ext_1 || msk_ext_2) {
        ...
        tmp_1 = _mm512_mask_i64gather_epi64(zero, msk_ext_1, idxes_1, (const void *)dp->tbl8, 8);
        tmp_2 = _mm512_mask_i64gather_epi64(zero, msk_ext_2, idxes_2, (const void *)dp->tbl8, 8);
